...
% n_pos = 2.0 * R * temp / F * asinh(j0_pos / (2.0 * reaction_rate_constant_pos * sqrt(initial_c_pos_electrolyte * (max_c_pos - initial_c_pos_electrolyte) * initial_c_pos_electrolyte)));
% n_neg = 2.0 * R * temp / F * asinh(j0_neg / (2.0 * reaction_rate_constant_neg * sqrt(initial_c_neg_electrolyte * (max_c_neg - initial_c_neg_electrolyte) * initial_c_neg_electrolyte)));
% 
% voltage = F * (R_film_pos * j0_pos - R_film_neg * j0_neg); 
