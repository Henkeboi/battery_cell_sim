...
j_neg_sampling = 200;
j_neg_T_len = 10;
j_neg_blender = Blender(0.1, @tf_j, [0], 'neg', const);
j_neg_blender.create_models(j_neg_T_len, j_neg_sampling);
j_neg_blender.sort();

j_pos_sampling = 200;
j_pos_T_len = 10;
j_pos_blender = Blender(0.1, @tf_j, [0], 'pos', const);
