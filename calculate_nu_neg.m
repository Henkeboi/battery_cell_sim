...
for i = 1 : size(s, 2)
    ...
    denominator = sqrt(R_solid_electrolyte_neg + R_neg / (F * diffusivity_neg) * (1.0 / (1.0 - R_solid_electrolyte_neg * coth(R_neg / sqrt(s(i) / diffusivity_neg)) * sqrt(s(i) / diffusivity_neg))));
