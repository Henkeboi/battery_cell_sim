function [] = tf_ce(cse, x_coordinates, T_len, sampling_f, const)
    ...
    disp("Calculate lambda and constant pairs.");
    lambda_list = [];
    k1_list = [];
    k3_list = [];
    k4_list = [];
    ...
    for l = 1 : 10
        ...
        k1_list = [k1_list eval(subs(rhs(eq5), lambda, l))];
        k3_list = [k3_list eval(subs(k3, lambda, l))];
        k4_list = [k4_list eval(subs(k4, lambda, l))];
        k5_list = [k5_list eval(subs(k5, lambda, l))];
        k6_list = [k6_list eval(subs(k6, lambda, l))];
    end
