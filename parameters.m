...
initial_electrolyte_average_concentration_neg = 4000;
...
temp = 25;
j0_neg = const.reaction_rate_neg * initial_electrolyte_average_concentration_neg ^ (1 - const.alpha_neg) * (const.solid_max_c_neg - initial_electrolyte_average_concentration_neg) ^ (1 - const.alpha_neg) * initial_electrolyte_average_concentration_neg ^ const.alpha_neg; 
j0_pos = const.reaction_rate_pos * initial_electrolyte_average_concentration_pos ^ (1 - const.alpha_pos) * (const.solid_max_c_pos - initial_electrolyte_average_concentration_pos) ^ (1 - const.alpha_pos) * initial_electrolyte_average_concentration_pos ^ const.alpha_pos; 

const.R_film_neg = 0.0;
const.R_film_pos = 0.0;
const.R_ct_neg = const.R * temp / (j0_neg * const.F ^ 2);
const.R_ct_pos = const.R * temp / (j0_pos * const.F ^ 2);
